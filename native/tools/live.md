...
The separate [ordinary-game capture workflow](viewport_diagnosis.md) now supplies matched raw/TSR/analytic stills at rest and during uninterrupted playback. Open the [gallery](../comparison.html). The fixed and latest moving images pass dense original-ray registration at 885/885 and 876/876 positions respectively. In the [new moving-frame report](../evidence/game-quality-20260905T221241048Z/README.md), raw pixels identify the saved time at 2.016666774 seconds; the other arms match its observed camera and readback phase. Playback continues through readback without a pause or final seek. One moving frame does not establish temporal quality across a trajectory. The earlier held-frame controls and output residuals remain archived.
