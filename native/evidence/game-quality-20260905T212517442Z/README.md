...
Status: measured-filter-specific-diagnostic. 54/54 fixed sample locations remain after geometry exclusions. Source time: 0 seconds (prepared fixed-camera metadata at its recorded time).
