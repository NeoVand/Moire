...
\begin{figure*}[t]
  ...
  near the two centers, where the superposition is a rosette and not a fringe field
  at all. Column~(e) draws nothing, and there is nothing there: the criterion refuses
  the whole frame, and the gray panel is flat. The whole bottom row costs two
