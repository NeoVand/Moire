...
frame, and the one structure the gray panel keeps, the bright corridor along the
asymptotes, belongs to the hyperbola family alone rather than to any beat
between the pair. Curves are also suppressed wherever consecutive level
