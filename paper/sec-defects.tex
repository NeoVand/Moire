...
% A single-column figure: the three panels are bold enough to read at a third
% of a column each, and the fork does not need a banner.
\begin{figure}[t]
  \centering
  \begin{subfigure}{0.32\linewidth}
    \includegraphics[width=\linewidth]{figures/defect-fork.png}
    \caption{$f=\theta/\tau$, $a=5$}
  \end{subfigure}\hfill
  \begin{subfigure}{0.32\linewidth}
    \includegraphics[width=\linewidth]{figures/defect-pair.png}
    \caption{over its twin}
  \end{subfigure}\hfill
  \begin{subfigure}{0.32\linewidth}
    \includegraphics[width=\linewidth]{figures/defect-envelope.png}
    \caption{five fringes end}
  \end{subfigure}
