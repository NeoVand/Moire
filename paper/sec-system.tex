...
toggles, a PNG export, and a JSON scene file that saves the construction---layers, camera, background---and nothing else. There are no layer effects and
no inspector; the pattern is the document.
