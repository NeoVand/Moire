...
| threshold of a quasi-periodic field (noise mask, scene 3) | conic from the jet near, exact roots along lines with quadrature across mid, the indicator's torus series far | WGSL, table of 25^3 coefficients | 0.0037 RMS at 19k spp (near and far at the floor; the band at 1.5 to 3 cycles a pixel 2e-3 to 6e-3) | 4.8 ms at 240x160 | first node, 2026-09-05 late |
