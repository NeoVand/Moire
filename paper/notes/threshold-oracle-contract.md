...
Open on this page: whether Lambda grows linearly or quadratically in m under the m-dependent envelope (the collaborator is checking), which decides how many moments a budget affords.
