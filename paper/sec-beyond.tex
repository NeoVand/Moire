...
\subsection{Fields with winding: defects}
\label{sec:defects}
...
$\gamma$ equals the enclosed charge times the gain: quantized, localized,
additive over defects, and blind to any single-valued field added on top. We
...
\begin{figure*}[t]
  ...
  \end{subfigure}
  \Description{Three square panels. The first is a field of fine vertical lines
...
\S\ref{sec:catalog} turns out to be the same object one level down: its index
