...
\begin{figure*}[t]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[shift={(img.south west)},
      ...
      \node[lab, text=ink, align=left, anchor=west] (gl) at (0.012,0.78)
        {the graph of\\$D=\idx_1-\idx_2$};
      \draw[lead, ink!65] (gl.south) to[out=-75,in=125] (0.0909,0.55);
      \node[lab, text=accent!88!ink, anchor=west] (cl) at (0.418,0.7875)
        {contours at $D\in\Z$};
      \draw[lead, accent!75] (cl.west) to[out=205,in=50] (0.352,0.6273);
      \node[lab, text=ink!80, align=center, anchor=south] (wl) at (0.285,0.9118)
        {steep:\\contours crowd};
      \draw[lead, ink!60] (wl.south) to[out=-85,in=95] (0.276,0.5695);
      \node[lab, text=ink!70, anchor=west] (rl) at (0.055,0.0578)
        {two ring families};
      \draw[lead, ink!55] (rl.east) to[out=10,in=205] (0.272,0.1291);
      \node[lab, text=cool!90!ink, align=right, anchor=east] (sl) at (0.995,0.7563)
        {the sum $\idx_1+\idx_2$:\\steep everywhere};
      \draw[lead, cool!75] (sl.west) to[out=-155,in=75] (0.8543,0.6737);
      \node[lab, text=cool!90!ink, align=left, anchor=west] (pl) at (0.552,0.8319)
        {flat only between\\the centres};
      \draw[lead, cool!75] (pl.south) to[out=-62,in=118] (0.752,0.4432);
    \end{scope}
  \end{tikzpicture}
  ...
  steep: contours crowd, and two ring families. Right: the same floor
  under the graph of the index sum, a bowl covered in tightly crowded
  blue rings with one bold flat bar between the centres; labels read the
  sum: steep everywhere, and flat only between the centres.}
