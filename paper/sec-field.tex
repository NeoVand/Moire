...
(Figure~\ref{fig:visibility}). The Studio draws it live, as a view toggled beside
the envelope, so an author sees where a fringe will form before committing to the
parameters.
