...
\begin{figure*}[t]
  ...
  the ring centres; labels read the graph of D, contours at integer D are
  the fringes, steep: contours crowd, and two ring families. Right: the
  same floor under the graph of the index sum, a bowl covered in tightly
  crowded blue rings with one bold flat bar between the centres; labels
  read the sum: steep everywhere, flat only between the centres, and no
  broad fringe.}
