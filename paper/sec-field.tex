...
with a floor $\ell$ that does not take part in the slide. A tap at $u$ then reads
\begin{equation}
...
pencil is first-order the same way, since its members rotate rather than slide, and so
