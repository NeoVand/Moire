...
layers~\cite{Amidror2003Moire, AmidrorII}. This theory is what tells you \emph{that} a
fringe exists and where its frequency lies. What it does not give you is a
renderer: it is a statement about spectra of images, and it presumes the layers
are (locally) periodic, or transforms of periodic structures.
...
curves of the standard configurations this way~\cite{Oster1964}, and Amidror gives
it as the geometric approach, complementary to the spectral
one~\cite{Amidror2009Theory}. This is the direct ancestor of our
...
fringes genuinely carry data is experimental mechanics, where moir\'e
interferometry has been used for decades to read in-plane displacement: fringes
are contour maps of displacement, with fringe order $N_x=fU$ for reference grating
frequency $f$, and strains follow by differencing fringe
orders~\cite{Post2008Moire, Post1994High}. That is a measurement technique, and its
governing relation is exactly our fringe law read in the other direction.
Section~\ref{sec:beyond} takes it as a design primitive instead.
...
tolerance into a certificate. The support-function facts we need are standard
...
difference~\cite{GJK1988, Ericson2004}; our contribution is noticing which four of
its properties this problem is asking for.
