...
\begin{figure*}[t]
  \centering
  % Stacked rows rather than side-by-side panels: the strip earns the whole
  % text width and the staircase below it can be genuinely large, with no
  % panel heights to reconcile.
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \begin{tikzpicture}
      \begin{axis}[paperaxis, height=4.9cm, width=0.58\textwidth,
