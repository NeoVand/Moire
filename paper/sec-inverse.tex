...
Two smaller consequences of the same observation are worth naming because they
are free. The solver takes an \emph{accept} threshold $t-a$: once a residual falls
...
\begin{figure*}[t]
  ...
  \begin{subfigure}[t]{0.62\textwidth}
    \vspace{0pt}
    \begin{tikzpicture}
      \begin{axis}[paperaxis, height=5.0cm,
  ...
  \begin{subfigure}[t]{0.35\textwidth}
    ...
    \begin{tikzpicture}
      \begin{axis}[paperaxis, height=5.0cm,
        ...
        \addlegendentry{$\pm16$, a fixed budget}
      \end{axis}
    \end{tikzpicture}
...
\State $\sigma \gets 2^{\lceil \log_2(\mathrm{span}/B) \rceil}$ \Comment{$1$ when the interval fits}
...
\begin{figure}[t]
  ...
  no enumeration of finite length can settle them. One evaluation of the constant
