...
The radial pencil and the three lattices sit on other rungs of the
taxonomy of \S\ref{sec:object}: the pencil is a defect, a lattice is rank
$2$. They render correctly, and both are classical enough that the beat is
well understood elsewhere \cite{Amidror2009Theory,Oster1964}. A
vector-valued fringe law that treated rank $2$ as native rather than
componentwise would be a genuine extension.
...
was asked for. We have argued that a pattern is a counting map and an ink
function, and that with those in hand the fringes stop being an accident.
They are the unit level sets of an integer character of $\cnt$
(Theorem~\ref{thm:fringe}), a statement that under its local hypotheses
needs no periodicity, no lattice, and no Fourier transform, and that we
measured holding on every family we tested, including one whose index
