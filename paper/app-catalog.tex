...
percent, because rotating a concentric family about its own centre does nothing at
...
index gradient is radial, rotation about the centre leaves $\nabla\idx$ unchanged
...
Two families deserve a note on their parameterisation, because the natural
...
arms for a pitch slider $B$. The rounding is not laziness. $\ph=r-b\theta$ has a
