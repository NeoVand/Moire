...
exported it from the Studio --- the scene file, camera included, is in the
repository.
...
Note what this predicts and the picture confirms ---
\emph{rotating} either spiral produces no new fringes, since a rotation only
