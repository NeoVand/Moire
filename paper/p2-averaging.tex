...
\placeholder{three exposures of one scene}{The still, and its long exposures
at rates $(1,1)$, $(1,2)$, $(2,1)$: the station present, absent, present,
absent (\texttt{exposure.mjs}). (P3.)}
...
\placeholder{the handover quilt, and its cure}{The identical-pitch walking
pair with a dipole field (\texttt{handover-quilt.json}): the aliased
finite-difference estimate's view beside the closed form's, at 1.87 pixels per
member. The aliased half is generated, never rendered by the old shader. (P3.)}
