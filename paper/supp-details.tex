...
lattice's index combinations carries the visible beat is the convention choice
of \S3.6 again, enlarged from a sign to a low-order integer vector: either
generator, their sum, or their difference --- for the hexagonal and triangular
lattices one of these is the third row direction --- each counted either way.
...
on the two-torus~\cite{Sloan1994Lattice, Keller2013Quasi}. The schedules are
worth recording: to hold a generator, step the pair by $(u,\,\{i\varphi\})$; to
hold their sum or difference with both bare indices still equidistributed, step
it by $(\{i\varphi\},\, \pm u - \{i\varphi\})$. A self-beat would need two
combinations held at once, which no schedule provides.

We record the choice because our first implementation fixed it globally --- one
generator, one way --- and the instrument said no: a partner family's counting
direction rotates around its centre, so whole sectors of a superposition kept
