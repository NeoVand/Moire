          ...
          <div className="px-3 py-2 border-b border-[var(--border)] flex-shrink-0">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                ...
                >
                  <ChevronLeft className="w-3 h-3 text-[var(--text-secondary)] group-hover:text-[var(--accent-primary)]" />
                </button>
              </div>
            </div>
          </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-0.5 ml-2">
                        <button
                          ...
                          className="w-5 h-5 hover:bg-[var(--bg-primary)] rounded transition-colors flex items-center justify-center"
                        >
                          {layer.visible ? (
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      className="w-full px-2 py-1 text-xs bg-[var(--bg-tertiary)] border border-[var(--border)] rounded focus:ring-1 focus:ring-[var(--accent-primary)]/50 focus:border-[var(--accent-primary)] text-[var(--text-primary)]"
                    >
